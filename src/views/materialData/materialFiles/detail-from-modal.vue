          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="性能参数：">
                <el-input v-model="formData.performanceParameters" autocomplete="off" :rows="2" type="textarea"
                  style="width: 300px" readonly />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="技术规格：">
                <el-input v-model="formData.technicalSpecification" autocomplete="off" :rows="2" type="textarea"
                  style="width: 300px" readonly />
              </el-form-item>
            </el-col>
          </el-row>
