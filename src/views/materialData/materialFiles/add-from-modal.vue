...
<template>
  <v-dialog show-full-screen
    ...
    <el-form :model="formData" label-width="130px" :rules="rules" ref="formRef">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="性能参数" prop="performanceParameters">
            <el-input v-model="formData.performanceParameters" clearable placeholder="请输入性能参数" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="技术规格" prop="technicalSpecification">
            <el-input v-model="formData.technicalSpecification" clearable placeholder="请输入技术规格" />
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
